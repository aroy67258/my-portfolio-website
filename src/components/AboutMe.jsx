...
const socials = [
  { icon: FaGithub,    href: 'https://github.com/aroy67258',                              label: 'GitHub',    glow: '#94a3b8' },
  { icon: FaLinkedinIn,href: 'https://www.linkedin.com/in/anupam-kumar-41655b296/',      label: 'LinkedIn',  glow: '#06b6d4' },
  { icon: FaEnvelope,  href: 'mailto:anupamroy11a@gmail.com',                            label: 'Email',     glow: '#a855f7' },
  { icon: FaInstagram, href: 'https://www.instagram.com/aroy67258?igsh=NXNlaGV6ZXhoeDdw', label: 'Instagram', glow: '#f97316' },
];

const infoGrid = [
  { icon: FaMapMarkerAlt, label: 'Location', value: 'Samastipur, Bihar — 848101', color: '#06b6d4' },
  { icon: FaEnvelope,     label: 'Email',    value: 'anupamroy11a@gmail.com',     color: '#a855f7' },
  { icon: FaPhone,        label: 'Phone',    value: '+91-9709463351',              color: '#06b6d4' },
  { icon: FaGraduationCap,label: 'Education',value: 'B.Tech CSE · MMMUT · 2027',  color: '#a855f7' },
];

const techTags = ['React.js','JavaScript','Python','FastAPI','Node.js','AI Tools','NLP','Prompt Engineering','Framer Motion','MongoDB'];
        ...
        <div className="flex flex-col gap-8">
          ...
          <motion.div {...fadeUp(0.1)}>
            <p className="text-slate-300 leading-relaxed text-base md:text-lg mb-4">
              I'm an aspiring{' '}
              <span className="text-cyanCustom font-semibold">Software Development Engineer</span>{' '}
          ...
          <motion.div {...fadeUp(0.2)} className="flex items-center gap-3 flex-wrap">
            ...
            {/* Resume Download */}
            <motion.a href={resumeImg} download="Anupam_Kumar_Resume.jpeg"
            ...
            <div className="p-8 flex flex-col gap-7">
              ...
              <div className="relative">
                ...
                <p className="text-slate-300 leading-relaxed pl-8 text-sm md:text-base">
                  ...
                  Currently pursuing B.Tech in CSE at{' '}
                  <span className="text-white font-medium">MMMUT, Gorakhpur</span> (2023–2027),
