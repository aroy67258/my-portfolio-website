...
const testimonials = [
  {
    ...
    color: '#06b6d4',
    rating: 5,
    text: "Anupam's portfolio is incredibly well-crafted. The UI is clean, modern, and the projects he's built are genuinely impressive. Would love to collaborate!",
  },
  {
    name: 'Rahul Verma',
    ...
    color: '#a855f7',
    rating: 5,
    text: "The healthcare platform case study blew me away. The depth of thinking and the quality of implementation is far beyond what I expected from a student portfolio.",
  },
  {
    name: 'Sneha Patel',
    role: 'UI/UX Designer',
    ...
    color: '#06b6d4',
    rating: 5,
    text: "Beautiful design sensibility and a clear understanding of user experience. Anupam clearly has a strong eye for both code quality and visual polish.",
  },
];
...
export default function FeedbackSection() {
  ...
  const handleSubmit = e => {
    ...
    const subject = encodeURIComponent(`Portfolio Feedback: ${form.type || 'General'}`);
    const body = encodeURIComponent(
      `From: ${form.name} (${form.email})\nType: ${form.type}\nRating: ${form.rating}/5\n\n${form.message}`
    );
    window.open(`mailto:anupamroy11a@gmail.com?subject=${subject}&body=${body}`);
    setSubmitted(true);
    setTimeout(() => { setSubmitted(false); setForm({ name: '', email: '', type: '', rating: 0, message: '' }); }, 5000);
  };
  ...
  return (
    <section id="feedback" className="py-24 relative overflow-hidden max-w-7xl mx-auto px-6 md:px-12 w-full">
      ...
      <div className="max-w-2xl mx-auto mb-16">
            ...
            {submitted ? (
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input name="name" value={form.name} onChange={handleChange}
                      ...
                      placeholder="Anupam Kumar" required className={inputClass('name')} />
                  </div>
                  <div>
                ...
                <p className="text-center text-xs text-slate-600 flex items-center justify-center gap-1.5">
                  ...
                  <span className="text-cyanCustom/70">anupamroy11a@gmail.com</span>
                </p>
              </motion.form>
            )}
          </AnimatePresence>
        ...
        >
          {[
            { icon: FaGithub, href: 'https://github.com/aroy67258', label: 'GitHub', color: 'hover:border-slate-400 hover:text-slate-200' },
            { icon: FaLinkedinIn, href: 'https://www.linkedin.com/in/anupam-kumar-41655b296/', label: 'LinkedIn', color: 'hover:border-cyanCustom hover:text-cyanCustom hover:shadow-[0_0_12px_rgba(6,182,212,0.3)]' },
            ...
            { icon: FaEnvelope, href: 'mailto:anupamroy11a@gmail.com', label: 'Email', color: 'hover:border-purpleCustom hover:text-purpleCustom hover:shadow-[0_0_12px_rgba(168,85,247,0.3)]' },
